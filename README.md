...
- **SillyTavern's default CSRF setting is fine** — the bridge fetches ST's CSRF token automatically before each request. You do not need to set `disableCsrf: true`.
